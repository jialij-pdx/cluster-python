...
#for test purpose
root = '/scratch2/tshott/BPA_Generic_test/tshott/BPA_data_test/140916'
...
def get_job():
    ...
    while True:
        ...
        if user_job == 'Y' or user_job == 'y' or user_job == 'yes':
            ...
            user_start_time = '2014-09-16 14:01:00'
            ...
            user_end_time = str(start_time + datetime.timedelta(minutes=10))
            user_type = 'A'
